...
const Nav = () => {
  return (
    <header className='padding-x py-5 after:absolute z-12 max-container'>
        <nav className='flex justify-center items-center '>
           ...
           <button className='bg-dark-blue hover:bg-light-blue text-white  py-1 px-12 font-montserrat' >
            Buy now
           </button>
           </div>
